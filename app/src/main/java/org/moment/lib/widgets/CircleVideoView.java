package org.moment.lib.widgets;
...
import org.moment.lib.widgets.videolist.VideoListGlideModule;
import org.moment.lib.widgets.videolist.model.VideoLoadMvpView;
import org.moment.lib.widgets.videolist.target.VideoLoadTarget;
import org.moment.lib.widgets.videolist.target.VideoProgressTarget;
...
public class CircleVideoView extends LinearLayout implements VideoLoadMvpView, ListItem {
    ...
    private void init() {
        ...
        videoFrame = findViewById(R.id.iv_video_frame);
        videoProgress = findViewById(R.id.video_progress);
        videoButton = findViewById(R.id.iv_video_play);
