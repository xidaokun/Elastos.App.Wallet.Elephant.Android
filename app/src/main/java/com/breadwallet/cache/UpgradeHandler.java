...
public class UpgradeHandler implements BRDataSourceInterface {
    ...
    public static void initString() {
        ...
        Beta.strNotificationClickToContinue = "Continue downloading";
        ...
        Beta.strNetworkTipsConfirmBtn = "Continue downloading";
        ...
        Beta.strUpgradeDialogUpgradeBtn = "Update immediately";
