...
public class WalletActivity extends BRActivity implements InternetManager.ConnectionReceiverListener,
    ...
    private void updateUi() {
        ...
        mCurrencyPriceUsd.setText(String.format("%s / %s", fiatExchangeRate, wm.getIso().equalsIgnoreCase("ELA-ESC")?"ELA":wm.getIso()));
            ...
            public void run() {
                ...
                BRExecutor.getInstance().forLightWeightBackgroundTasks().execute(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String result = CryptoUriParser.createElapayUrl(walletManager, factory.getAmount(), factory.getReceivingAddress(), des);
