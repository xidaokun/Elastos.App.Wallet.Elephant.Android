package com.qupai.lib.common;


import com.qupai.lib.utils.FileUtils;
...
public class Contant {
    ...
    public static final String domain="http://xidaokun.io/cicledemo.s.qupai.me";//当前TEST应用的域名。该地址每个应用都不同
