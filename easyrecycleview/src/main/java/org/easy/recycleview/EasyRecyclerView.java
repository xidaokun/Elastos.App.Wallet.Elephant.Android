...
import org.easy.recycleview.swipe.SwipeRefreshLayout;
...
public class EasyRecyclerView extends FrameLayout {
    ...
    protected void initAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            mScrollbarStyle = a.getInteger(R.styleable.EasyRecyclerView_scrollbarsStyle, -1);
